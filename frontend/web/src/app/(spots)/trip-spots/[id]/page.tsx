...
// import { useTripSpotById } from "@/hooks/queries/useTrips";

export default function TripSpotDetailPage({
  params,
}: {
  params: { id: string };
}) {
  ...
  // if (isError || !data?.data?.dataBody) return <div>오류가 발생했습니다.</div>;

  // const spot = data.data.dataBody;
