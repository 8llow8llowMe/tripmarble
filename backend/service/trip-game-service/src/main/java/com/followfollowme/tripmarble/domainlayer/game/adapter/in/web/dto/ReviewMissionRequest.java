...
@Schema(description = "여행지 리뷰 미션 요청 DTO")
public record ReviewMissionRequest(

    @Schema(description = "여행지 ID", example = "123")
    @NotBlank(message = "여행지 ID는 필수입니다.")
    String tripSpotId,
    ...
    @DecimalMin(value = "1.0", message = "별점은 최소 1점 이상이어야 합니다.")
    @DecimalMax(value = "5.0", message = "별점은 최대 5점 이하이어야 합니다.")
    double rating,
